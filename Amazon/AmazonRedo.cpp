...
public:
//3 options: private, public, and protected
        ...
        // constructor: special function that "initializes" attributes to a default value
        AmazonItemsForSale() {
          price = 0.0;
          sellerID = 100;
        }
...
int main(){
  ...
  //===================================================
  //Creating variables thst have no name
  ...
  cout << "First box is in the heap!" << endl;
  cout << customer->price << " " << customer->sellerID << endl;
  cout << "Second box is in the heap!" << endl;
